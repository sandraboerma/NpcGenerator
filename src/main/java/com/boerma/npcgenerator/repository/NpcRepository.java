...
public interface NpcRepository extends JpaRepository<Npc, Integer> {
    ...
    @Query("SELECT new com.boerma.npcgenerator.dto.NpcDisplayDto(n.id, fn.firstName, ln.lastName, n.age, r.raceName, p.professionName, ss.statusName, g.genderName) " +
            "FROM Npc n " +
            ...
            "JOIN Gender g ON n.genderId = g.id")
